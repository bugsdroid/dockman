...
TUI mode (curses) dihapus di v3 - digantikan oleh Bootstrap Wizard
dan menu numbered 3 kolom yang lebih user-friendly.
"""
...
def main():
    ...
    # --tui: tampilkan pesan bahwa TUI dihapus di v3
    if "--tui" in args:
        print(f"\n  {config.APP_NAME} v{config.VERSION}")
        print("  TUI mode (curses) tidak tersedia di v3.")
        print("  Gunakan menu default: dockman")
        print("  Atau Bootstrap Wizard: dockman --bootstrap\n")
        sys.exit(0)
